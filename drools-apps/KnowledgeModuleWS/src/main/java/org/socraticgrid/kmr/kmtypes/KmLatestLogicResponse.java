...
public class KmLatestLogicResponse {
    ...
    protected int id;
    @XmlElement(name = "Logic_IntermediateForm", namespace = "urn:org:socraticgrid:kmr:kmtypes", required = true)
    protected String logicIntermediateForm;
    @XmlElement(name = "Logic_NativeForm", namespace = "urn:org:socraticgrid:kmr:kmtypes", required = true)
    protected String logicNativeForm;
    @XmlElement(name = "Logic_BinaryForm", namespace = "urn:org:socraticgrid:kmr:kmtypes", required = true)
