...
public class PopulationSpecificationPK implements Serializable {
   ...
   public String toString() {
      return "org.socraticgrid.kmr.model.PopulationSpecificationPK[bpId=" + bpId + ", terminologyScheme=" + terminologyScheme + ", terminologyCode=" + terminologyCode + ", terminologyValue=" + terminologyValue + "]";
   }
