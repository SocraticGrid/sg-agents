 ...
 *         &lt;element name="SpecialtyList" type="{urn:org:socraticgrid:kmr:kmtypes}SpecialtyListType"/>
 *         &lt;element name="KmVersionList" type="{urn:org:socraticgrid:kmr:kmtypes}KmVersionListType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class KmFullResponse {
    ...
    @XmlElement(name = "SpecialtyList", namespace = "urn:org:socraticgrid:kmr:kmtypes", required = true)
    protected SpecialtyListType specialtyList;
    @XmlElement(name = "KmVersionList", namespace = "urn:org:socraticgrid:kmr:kmtypes", required = true)
