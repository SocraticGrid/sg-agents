 ...
 *         &lt;element name="Specialty" type="{urn:org:socraticgrid:kmr:kmtypes}KM_Specialty_SimpleType" minOccurs="0"/>
 *         &lt;element name="Fact" type="{urn:org:socraticgrid:kmr:kmtypes}KMV_FactDependency_SimpleType" minOccurs="0"/>
 *         &lt;element name="PopulationDependency" type="{urn:org:socraticgrid:kmr:kmtypes}KMV_PopulationDependency_SimpleType" minOccurs="0"/>
 *         &lt;element name="Inference" type="{urn:org:socraticgrid:kmr:kmtypes}KMV_InferenceEngineDependency_SimpleType" minOccurs="0"/>
 *         &lt;element name="Task" type="{urn:org:socraticgrid:kmr:kmtypes}KMV_TaskDependency_SimpleType" minOccurs="0"/>
 *         &lt;element name="ACL" type="{urn:org:socraticgrid:kmr:kmtypes}ACL_SimpleType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class KmByParamsType {
    ...
    @XmlElement(name = "Specialty", namespace = "urn:org:socraticgrid:kmr:kmtypes")
    protected KMSpecialtySimpleType specialty;
    @XmlElement(name = "Fact", namespace = "urn:org:socraticgrid:kmr:kmtypes")
    protected KMVFactDependencySimpleType fact;
    @XmlElement(name = "PopulationDependency", namespace = "urn:org:socraticgrid:kmr:kmtypes")
    protected KMVPopulationDependencySimpleType populationDependency;
    @XmlElement(name = "Inference", namespace = "urn:org:socraticgrid:kmr:kmtypes")
    protected KMVInferenceEngineDependencySimpleType inference;
    @XmlElement(name = "Task", namespace = "urn:org:socraticgrid:kmr:kmtypes")
    protected KMVTaskDependencySimpleType task;
    @XmlElement(name = "ACL", namespace = "urn:org:socraticgrid:kmr:kmtypes", required = true)
